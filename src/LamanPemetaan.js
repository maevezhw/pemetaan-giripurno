...
function Pemetaan() {
    return (
        <div className="bg-grey font-roboto snap-y snap-mandatory h-lvh overflow-y-scroll scroll-smooth">
            ...
            <div className="snap-start snap-mandatory flex flex-col">
                <div className="px-4 md:px-10 lg:px-20 xl:px-44 pt-6 flex flex-col justify-center items-center flex-grow">
                    <h1 className="text-xl md:text-2xl lg:text-3xl font-bold mb-4 text-center">Hasil Pemetaan Daerah Giripurno Periode Juli 2024</h1>
